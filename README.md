# Olá, eu sou o Alessandro Coran Filho! 👋

### Desenvolvedor Back-end | Java & Spring Boot

Sou um entusiasta da tecnologia que iniciou os estudos em 2021 com o Front-end (HTML, CSS, JavaScript), mas acabei encontrando minha verdadeira paixão na robustez e lógica do **Java**.

- 🚀 Atualmente aprimorando conhecimentos em **Spring Boot** e **MySQL**.
- 🛠️ Experiência com: Java, Spring Boot, JavaFX, SQL (MySQL/SQLite) e Git.
- 🎓 Foco em transformar lógica complexa em soluções simples e funcionais.
